...
print('1. Initialize LogisticRegression class from student solution... ', end='')
...
lr.class_dict = {'action': 0, 'comedy': 1}
print('PASSED')

print('2. Train classifier on movie_reviews_small dataset... ')
...
correct_theta = np.array([-0.00770846,  0.04229154, -0.0812512 ,  0.0089582 , -0.01500073])
...
correct_results = {'6.txt': {'correct': 0, 'predicted': 0},
                    '7.txt': {'correct': 1, 'predicted': 1},
                    '8.txt': {'correct': 0, 'predicted': 0},
                    '9.txt': {'correct': 1, 'predicted': 0}}
